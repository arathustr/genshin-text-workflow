...
const TOPICS = [
  {
    ...
    queryTerms: ['自由', '秩序', '束缚', '枷锁', '压迫', '规矩', '约束', '散漫', '反抗', '服从', '管束', '强制', '不得不', '收缴', '自由之敌'],
  ...
  },
  {
    ...
    queryTerms: ['权力', '责任', '代价', '契约', '承担', '负责', '失职', '职位', '管理者', '校方', '老师', '教授'],
  ...
  },
  {
    ...
    queryTerms: ['教育', '学校', '高校', '大学', '学生', '课堂', '上课', '出勤', '手机袋', '手机', '老师', '导师', '教授', '学习', '知识', '求知', '风纪', '教令', '规训'],
  ...
  },
  {
    ...
    queryTerms: ['监控', '摄像头', '识别', '算法', '数据', '系统', '记录', '打卡', '签到', '定位', '技术治理', '编号', '自动化', '终端', '虚空', '权力', '责任', '风纪', '教令'],
  ...
  },
  {
    ...
    queryTerms: ['信任', '伙伴', '棋子', '工具', '敌人', '人', '人格', '尊重', '利用', '操控', '编号', '对象化', '成年人', '不可信'],
  ...
  },
  {
    ...
    queryTerms: ['冷暴力', '沉默', '不回消息', '不接电话', '疏离', '等待', '背叛', '欺骗', '关系', '恋爱', '分手', '信任破裂', '伤心'],
  ...
  },
  {
    ...
    queryTerms: ['审判', '公正', '法律', '罪', '惩罚', '证据', '调查', '真相', '程序', '处罚', '问责', '举报'],
  ...
  },
  {
    ...
    queryTerms: ['暴力', '打人', '伤害', '恐惧', '危险', '保护', '安全', '受害者', '威胁', '伤口', '痛苦'],
  ...
  },
  {
    ...
    queryTerms: ['记忆', '遗忘', '历史', '真相', '记录', '叙事', '谣言', '传言', '舆论', '证词'],
  ...
  },
  {
    ...
    queryTerms: ['流程', '申请', '命令', '管理', '许可', '审批', '效率', '考核', '指标', '制度', '控制', '治理', '强制', '收缴', '打卡', '出勤'],
  ...
  },
  {
    ...
    queryTerms: ['尊严', '身份', '名字', '证明', '编号', '主体性', '成年人', '人格', '标签', '清点'],
